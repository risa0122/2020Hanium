...
public class MenuListViewActivity extends Activity {

    ListView listView;
    MenuDBHelper helper;
    Cursor cursor;
    MenuCursorAdapter adapter;
    ListView lv;
    long id;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        helper = new MenuDBHelper(this);

        adapter = new MenuCursorAdapter(MenuListViewActivity.this, R.layout.activity_menu_list_view, null);
...
//		리스트 뷰 클릭 처리
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(MenuListViewActivity.this, MenuViewActivity.class);
...
//		리스트 뷰 롱클릭 처리
    ...
    //      DB에서 데이터를 읽어와 Adapter에 설정
            ...
            cursor = db.rawQuery("select * from " + MenuDBHelper.TABLE_NAME, null);
